...
declare namespace CodeceptJS {
    ...
    export interface I {
        ...
        addMochawesomeContext(context: LocatorOrString) : void,
        ...
        initGcpObject() : void,
        ObjectToUrl(object: string) : void,
        randomString(length: string, prefix: string, suffix: string, type: string) : void,
        DateTimeStamp() : void,
        genrateGcpData(type: string) : void,
        getVisibility(selector: string, options: string) : void,
        reloadUntilVisible(element: string, interval: string, numberOfReload: string) : void,
        say: () => any;
